...
![On the other hands, most of the modelling packages in R is expecting a matrix look similar to the figure below.](images/clipboard-1847951502.png)

![](images/clipboard-1066779645.png)
...
![The default field name is very messy, we will rename it to `accHansen` by using the code chunk below.](images/clipboard-412646305.png)

```{r}
colnames(acc_Hansen) <- "accHansen"
```

The field name is much more tidier now.

![Next, we will convert the data table into tibble format by using the code chunk below.](images/clipboard-1904820215.png)
...
Notice that hexagon_Hansen is a simple feature data frame and not a typical tibble data frame.undefined

![Actually, the steps above can be perform by using a single code chunk as shown below.](images/clipboard-2963162496.png)
...
### **17.7.2 Visualising KD2SFCA’s accessibility17.8 Modelling and Visualising Accessibility using Spatial Accessibility Measure (SAM) Method**
